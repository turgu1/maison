...
// displayed from the MQTT Broker and display the information on 
// a LED matrix display build from 8x8 cells.
//
...
void matrix_callback(char* topic, byte* payload, unsigned int length) 
{
  int i;
